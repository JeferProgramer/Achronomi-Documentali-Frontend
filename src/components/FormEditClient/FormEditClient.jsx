                  ...
                  <Stack spacing={8} mx={'auto'} maxW={'lg'} py={12} px={6}>
                    <Stack align={'space-between'}>
                      <Stack direction='row'>
                        ...
                        <Button maxW={"40%"} fontSize={"sm"} rounded={"full"} _focus={{ bg: "#090964.600" }} bg={"#090964"} color="white" _hover={{ bg: "white", color: "#090964" }}>
                        ...
                        <FormControl id="country">
                          ...
                          <PlacesAutocomplete value={address} onChange={setAddress} onSelect={handleLocation} >
                            {({ getInputProps, suggestions, getSuggestionItemProps, loading }) => (
                              <div>
                                <Input variant='flushed' color='#090964' bg='white' mt='2em'{...getInputProps({ placeholder: "Selecciona tu localidad" })} />
                                <div>
                                  {loading ? <BiLoader /> : null}

                                  {suggestions.map(suggestion => {
                                    const style = {
                                      backgroundColor: suggestion.active ? "#718096" : "#090964"
                                    };

                                    return (
                                      <option className='LocationOptions' color='#090964'
