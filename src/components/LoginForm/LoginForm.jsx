...
function LoginForm() {
  ...
  //   const response =  axios.get("https://achrono-documentali-backend.vercel.app/userclient/auth/google")
  // }
    ...
    <div className="background">
      ...
      >
        {tokenClient || tokenPsychologist ? (
          ...
          <>
            <Text fontSize="2xl" color={"#090964"} marginBottom="1em">
              Inicia sesión
            </Text>
            ...
            >
              <Box direction="column" align="center" width="60%">
                <form onSubmit={handleInputSubmit}>
                  ...
                  />
                  {formErrors.email && (
                    <Text fontSize="sm" color="#090964.500">
                      {formErrors.email}
                    </Text>
                  )}
