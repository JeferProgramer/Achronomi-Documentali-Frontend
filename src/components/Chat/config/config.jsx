    ...
    },
    {
      ...
      props: {
        options: [
          {
            text: "Psicologia",
            url: "https://achronomi-documentali-frontend.vercel.app/home",
            id: 1,
          }, {
            text: "Blog de Psicologia",
            url: "https://achronomi-documentali-frontend.vercel.app/blog",
            id: 3
          }
        ]
      }
    },//muestro las opciones de contacto a travez del componente link list
    {
      ...
      props: {
        options: [
          {
            text: "Sitio Web",
            url: "https://achronomi-documentali-frontend.vercel.app",
            id: 1,
          }, {
            text: "Email",
            url: "mailto:AchronoDocumentali@gmail.com?Subject=ChatBot Query",
            id: 2
          }
        ]
      }
