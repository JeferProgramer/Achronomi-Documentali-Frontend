class ActionProvider {
    ...
    handleSecion = () => {
        const message = this.createChatBotMessage(
            "En la parte superior de la pagina en la sección Profesionales puedes ver los que estan disponibles y agendar una sesión con el profesional de tu preferencia"
        )
        this.updateChatbotState(message)
    }
    handleQuejas = () => {
    ...
    handleMatricula = () => {
        const message = this.createChatBotMessage(
            "En AchronoDocumentali nos encargamos de revisar que los Profesionales disponibles en el aplicativo tengan verificada y verídica su matricula para darle la mejor experiencia al cliente"
        )
        this.updateChatbotState(message)
    }
    handlePagos = () => {
        const message = this.createChatBotMessage(
            "En AchronoDocumentali como metodos de pago tenemos Visa, Mastercard y American Express. De esta forma, con Stripe se optimiza las vías de enrutamiento, proporciona la información más detallada y disminuye la latencia en las transacciones."
        )
        this.updateChatbotState(message)
    }
    handleSorry = () => {
