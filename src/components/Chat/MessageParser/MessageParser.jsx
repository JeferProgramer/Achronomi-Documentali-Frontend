class MessageParser {
    ...
    parse(message) {
        ...
        else if (lowerCaseMessage.includes("contactanos") || lowerCaseMessage.includes("contacto") || lowerCaseMessage.includes("AchronoDocumentali") || lowerCaseMessage.includes("email")) {
