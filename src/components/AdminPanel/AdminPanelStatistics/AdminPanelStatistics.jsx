...
function AdminPanelStatistics() {
    ...
    /*---grafico---*/
    const data = {
        labels: ['Clientes', 'Profesionales', 'Pagos'],
        datasets: [{
            label: 'Totales',
            backgroundColor: '#c6f6d5',
            data: [allUserClients.length, allUsersPsichologists.length, allPayments.length]
        }]
    }
    const options = {
                                ...
                                <Stack width='100%' height='fit-content' bg='white' p='2%' direction='column' justifyContent='center' align='center' boxShadow={`0px 0px 10px 0px rgba(0,0,0,0.3)`}>
                                    {
                                        loader
                                            ...
                                            : (
                                                <>
                                                    {
                                                        (allUserClients.length !== 0 && allUsersPsichologists.length !== 0 && allPayments.length !== 0)
