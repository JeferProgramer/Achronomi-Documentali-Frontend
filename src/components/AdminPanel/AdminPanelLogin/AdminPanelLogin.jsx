            ...
            <Stack width='100%' height='80%' direction='column' justifyContent='center' alignContent='center' alignItems='center'>
                <Stack width='inherit' height='inherit' ml='1em' mr='1em' direction='column' justifyContent='center' alignItems='center'>
                    ...
                    <Stack pr='1em' pl='1em' mb='0.5em'>
                        <Text color='#090964' fontSize='5xl' fontWeight='500' mt='0.5em' mb='0.5em'>AchronoDocumentali</Text>
                    </Stack>
                                ...
                                ? (
                                    ...
                                    <>
                                        ...
                                        <form onSubmit={handleInputSubmit}>
                                            ...
                                            {formErrors.email && <Text mt='0' mb='1em' fontSize='sm' color='#090964.500'>{formErrors.email}</Text>}
                                            ...
                                            {formErrors.password && <Text mb='1em' fontSize='sm' color='#090964.500'>{formErrors.password}</Text>}

                                            <Button type='submit' mt='1em' size='lg' bg='#090964' color='white' variant='solid' _hover={[{ color: '#090964' }, { bg: '#090964' }]}>
                                                Ingresar
                                            </Button>
                                        </form>
                                    </>
