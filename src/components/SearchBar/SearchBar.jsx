...
export default function SearchBar() {
  ...
  return (
    ...
    <form className='formSearchbar' onSubmit={(e) => handleSubmit(e)}>
      <Input focusBorderColor='#090964.400' onChange={(e) => handleInputChange(e)} value={title} placeholder='Buscar notas...' />
      {/* <ButtonGroup direction='row' variant="outline"> */}
      <Button variant='outline' colorScheme='#090964' type='submit' ml='0.5em'>
        <BsSearch />
      </Button>
      {/* </ButtonGroup> */}
    </form>
