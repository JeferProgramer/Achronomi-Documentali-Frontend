...
export default function CardPsychologist({ firstName, lastName, Specialties, profileImage, rating, education, about, IdUserPsychologist }) {
    ...
    console.log("profileImage", `${baseURL}/${profileImage}`);
    ...
    return (
        <Box className="cardPsychologistContainer" rounded="7px" boxShadow={`0px 0px 10px 0px rgba(0,0,0,0.3)`}>
            ...
            <Box className="containerBottom" borderLeftWidth='0.1em' borderColor='#b7b7b7' pl='1em'>
                ...
                <Text color='#090964.700' marginTop='1em' className="textcalendar">
                ...
                </Text>
                {
                    tokenClient || tokenPsychologist
                        ? (
                            ...
                            <Button className="appointmentButton" mt='1em' bg={'#090964'} color='white' variant='solid' _hover={[{ color: '#090964' }, { bg: 'white' }]} size='lg' onClick={handleCalendar}>
                                Pedir cita
                            </Button>
                            /*  </Link> */
                        ) : (
                            <Button className="appointmentButton" mt='1em' bg={'#090964'} color='white' variant='solid' _hover={[{ color: '#090964' }, { bg: 'white' }]} size='lg' onClick={() => navigate('/signin')}>
                                Pedir cita
                            </Button>
                        )
                }
