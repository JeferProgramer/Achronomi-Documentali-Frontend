        ...
        <VStack w={'100%'} px={'20%'} alignItems={'flex-start'}>
          {
            inputDate
              ? <Stack direction='row' align='center'>
                ...
                {
                  input.date
                    ? <Text bg='#090964.100' p='0.5em' borderRadius='0.5em'>
              ...
              input.hours.length !== 0
                ? (
                  input.hours.map((hour) => {
                    let hourUTC = new Date(hour)
                    return (
                      <Stack direction='row' align='center' bg='#090964.100' p='0.5em' borderRadius='0.5em'>
          ...
          <Button bg={"#090964"} colorScheme='black' onClick={(e) => handleInputSubmit(e)}>
