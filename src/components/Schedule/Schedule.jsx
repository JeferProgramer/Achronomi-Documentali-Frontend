                ...
                <VStack mb='2em' alignItems='center' justifyContent='center' width='90%' spacing={'20px'}>
                    ...
                    <HStack alignItems={'space-between'} justifyContent={'flex-start'} p='1em' w={'100%'} gap={'60px'} height={'100%'}>
                        ...
                        <VStack w={'100%'} alignItems={'flex-start'} justifyContent={'space-around'}>
                            <HStack mb={'5px'}>
                                <Text fontSize='xl' color='#090964' textAlign='left'>
                                    Fecha seleccionada:
                                </Text>
                                {
                                    dateTime !== undefined
                            ...
                            <Stack d={'flex'} alignItems={'flex-start'}>
                                <Stack direction='row' align='center'>
                                    <Text fontSize='xl' color='#090964' textAlign='left'>Horario seleccionado:</Text>
                                    {
                                ...
                                <Stack direction='column' width='100%' maxHeight='8em' overflowY='scroll'>
                                    {
                                        hours && hours.map((hour) => {
                                            ...
                                            return (
                                                <Button key={hourUTC} mb='0.5em' p='1em' width='100%' bg='white' name='hour' size={'md'} value={hourUTC} onClick={(e) => handleTypeAndHour(e)}>
                            ...
                            <VStack width='100%' pb='2em' mt={'1em'} alignItems={'flex-start'}>
                                {/* <Text fontSize='xl' color='#090964'>Te gustaría que la sesión sea: {appointmentData.type}</Text> */}
                                <Stack direction='row' align='center'>
                                    <Text fontSize='xl' color='#090964' textAlign='left'>Te gustaría que la sesión sea:</Text>
                                    {
                                ...
                                <Stack direction='row' width='inherit'>
                                    <Button colorScheme='#090964' variant='outline' width='50%' name='type' value='Virtual' onClick={(e) => handleTypeAndHour(e)}>
                                        Virtual
                                    </Button>
                                    <Button colorScheme='#090964' variant='outline' width='50%' name='type' value='Presencial' onClick={(e) => handleTypeAndHour(e)}>
                                        Presencial
                                    </Button>
                                </Stack>
                            </VStack>
