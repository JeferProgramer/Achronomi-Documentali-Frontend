...
let AchronoDocumentaliTax = psychologistCommission * 0.05;
let total = (psychologistCommission + stripeTax + AchronoDocumentaliTax)
      ...
      const line_items = [
         {
            ...
            price_data: {
               ...
               product_data: {
                  ...
                  description: 'AchronoDocumentali S.A.',
   ...
   return (
      <VStack w={'full'} h={'100%'} p={10} spacing={10} py={5} alignItems='flex-start'>
         ...
         <SimpleGrid column={2} columnGap={3} rowGap={6} w={'full'}>
            ...
            {(input.email === "" || !regEmail.test(input.email)) ? <Button isDisabled colorScheme={'#090964'} type='submit' onClick={handleGuestCheckout}>
               Pagar Sesión
            </Button> :
               <Button colorScheme={'black'} bg={'#090964'} type='submit' onClick={handleGuestCheckout}>
                  Pagar Sesión
               </Button>
            }
         </SimpleGrid>
