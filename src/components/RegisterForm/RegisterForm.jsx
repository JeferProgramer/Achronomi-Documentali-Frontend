            ...
            <Container zIndex='1' height='inherit' direction='column' justifyContent='center' p='2em' centerContent>
                {
                    tokenClient || tokenPsychologist
                        ? (
                            <Box width='100%' bg='#090964' color='#262626' borderRadius='1em' paddingTop='2em' paddingBottom='2em' align='center'>
                                <Text fontSize='2xl' color={'white'} marginBottom='1em'>
                                    No puedes registrarte mientras tu sesión siga abierta
                                </Text>
                                <Link to='/home'>
                                    <Button type='submit' bg={'#090964'} color='white' variant='solid' _hover={[{ color: '#090964' }, { bg: 'white' }]}>
                                        Ir al home
                                    </Button>
                                </Link>
                            </Box>
                            ...
                            <>
                                <Text fontSize='2xl' color={'#090964'} paddingBottom='1em'>
                                    Registro
                                </Text>

                                <Box minWidth='container.sm' direction='row' align='center' >
                                    <Button
                                        bg={userClientBtn ? "#090964" : "blackAlpha.600"}
                                        variant='solid'
                                        width='50%'
                                        color='white'
                                    ...
                                    <Button
                                        bg={userClientBtn ? "blackAlpha.600" : "#090964"}
                                        variant='solid'
                                        width='50%'
                                        color='white'
                                ...
                                <Box minWidth='container.sm' bg='#090964' color='#262626' borderBottomRadius='1em' pt='1em' pb='2em' align='center'>
                                    <Box direction='column' align='center' width='60%'>
                                        <form onSubmit={handleInputSubmit}>
                                            ...
                                            {formErrors.firstname && <Text fontSize='sm' color='white'>{formErrors.firstname}</Text>}

                                            <Input name='lastname' variant='flushed' placeholder=' Apellido' bg='white' mt='2em' onChange={handleInputChange} />
                                            {formErrors.lastname && <Text fontSize='sm' color='white'>{formErrors.lastname}</Text>}

                                            <Input name='email' variant='flushed' placeholder=' Email' bg='white' mt='2em' onChange={handleInputChange} />
                                            {formErrors.email && <Text fontSize='sm' color='white'>{formErrors.email}</Text>}
                                            <Input
                                                name='birthdate'
                                                variant='flushed'
                                                color='gray.500'
                                            ...
                                            {formErrors.birthdate && <Text fontSize='sm' color='white'>{formErrors.birthdate}</Text>}
                                            <>
                                                {userClientBtn ? (
                                                    <>
                                                        ...
                                                        {formErrors.country && <Text fontSize='sm' color='white'>{formErrors.country}</Text>}
                                                ...
                                                !userClientBtn
                                                    ? (
                                                        <>
                                                            <PlacesAutocomplete value={address} onChange={setAddress} onSelect={handleLocation} >
                                                                {({ getInputProps, suggestions, getSuggestionItemProps, loading }) => (
                                                                    <div>
                                                                        ...
                                                                        {formErrors.location && <Text fontSize='sm' color='white'>{formErrors.location}</Text>}
                                                                    </div>
                                                            ...
                                                            {formErrors.specialities && <Text fontSize='sm' color='white'>{formErrors.specialities}</Text>}

                                                            <ul>
                                                                {signupForm.specialities ? signupForm.specialities.map((e) => (
                                                                    <Stack direction='row' margin='0.2em'>
                                                                        <Text fontSize='md' color='white'>{e}</Text>
                                                                        <BiX onClick={() => handleSpecialitiesDelete(e)} className='iconX' color='white' />
                                                                    </Stack>
                                                                ))
                                                                    : null
                                                                }
                                                            ...
                                                            {formErrors.license && <Text fontSize='sm' color='white'>{formErrors.license}</Text>}

                                                            <Input name='dni' variant='flushed' placeholder=' D.N.I.' bg='white' marginTop='2em' onChange={handleInputChange} />
                                                            {formErrors.dni && <Text fontSize='sm' color='white'>{formErrors.dni}</Text>}

                                                            <Input name='education' variant='flushed' placeholder=' Educacion' bg='white' marginTop='2em' onChange={handleInputChange} />
                                                            {formErrors.education && <Text fontSize='sm' color='white'>{formErrors.education}</Text>}
                                                        </>
                                                    )
                                                    : null
                                            }
                                            ...
                                            {formErrors.password && <Text fontSize='sm' color='white'>{formErrors.password}</Text>}
                                            ...
                                            <Stack direction='column' align='center'>
                                                <Button type='submit' bg={'gray'} color='white' variant='solid' _hover={[{ color: '#090964' }, { bg: 'white' }]} marginTop='2em'>
                                                    Registrarse
                                                </Button>
                                                {/* {
                                                    userClientBtn
                                                        ? <Button bg='#090964' color={'#090964'} >
                                                            Registrate con &nbsp; <FaGoogle />
                                                        </Button>
                                                        : null
                                                } */}
                                                <Button bg='#090964' color={'white'} onClick={() => navigate('/signin')} >
